...
interface AfterAuthNavigationUtilOptions {
    ...
    preventRedirectUrlOriginCleaning?: boolean;
}
/**
 ...
 */
export declare function afterAuthNavigation(payload?: Pick<AfterAuthNavigationUtilOptions, 'preventRedirectUrlOriginCleaning'>): Generator<import("redux-saga/effects").SelectEffect | import("redux-saga/effects").CallEffect<void>, void, {
    routes: {
