...
declare const acceptInvitationState: AcceptInvitationState;
declare const reducers: {
    setAcceptInvitationState: {
        prepare: (payload: Partial<AcceptInvitationState>) => {
            payload: Partial<AcceptInvitationState>;
        };
    ...
    resetAcceptInvitationState: (state: import("..").AuthState) => {
        onRedirectTo: (path: string, opts?: import("@frontegg/rest-api").RedirectOptions | undefined) => void;
        error?: any;
        isAuthenticated: boolean;
        userIp?: string | undefined;
...
declare const actions: {
    acceptInvitation: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[IAcceptInvitation], IAcceptInvitation, string, never, never>;
};
/**
...
export declare type AcceptInvitationActions = DispatchedActions;
