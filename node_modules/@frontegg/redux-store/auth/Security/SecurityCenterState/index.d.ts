...
import { IForgotPassword } from '@frontegg/rest-api';
...
declare const actions: {
    ...
    sendResetBreachedPasswordEmail: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[WithCallback<IForgotPassword, boolean>], WithCallback<IForgotPassword, boolean>, string, never, never>;
...
declare type DispatchedActions = {
    ...
    loadInsights: () => void;
    sendResetBreachedPasswordEmail: (payload: WithCallback<IForgotPassword>) => void;
    sendBulkResetBreachedPasswordEmails: (payload: WithCallback) => void;
