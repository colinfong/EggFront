...
declare const accountSettingsState: AccountSettingsState;
declare const reducers: {
    setAccountSettingsState: {
        prepare: (payload: Partial<AccountSettingsState>) => {
            payload: Partial<AccountSettingsState>;
        };
...
declare const actions: {
    loadAccountSettings: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[(WithCallback<{
        silentLoading?: boolean | undefined;
    }, boolean> | undefined)?], WithCallback<{
        silentLoading?: boolean | undefined;
    }, boolean> | undefined, string, never, never>;
    saveAccountSettings: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[WithCallback<ISettingsResponse, ISettingsResponse>], WithCallback<ISettingsResponse, ISettingsResponse>, string, never, never>;
};
/**
...
export declare type AccountSettingsActions = DispatchedActions;
